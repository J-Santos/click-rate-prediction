...
sizes = [9027268, 10976278, 3116575]
...
device = events.platform.value_counts()
plt.figure(figsize=(12,4))
sns.barplot(device.index, device.values, alpha=0.8, color=p[1])
...
page_views_sample_df = pd.read_csv("./Data/events.csv", usecols=['uuid', 'geo_location'])
# Drop NAs
